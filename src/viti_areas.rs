...
#[get("/viti-areas/<id>")]
pub async fn get_one(auth: Auth, id: i32, conn: Connection<Db>) -> RestResult<VitiArea> {
...
pub async fn post(
    ...
    let viti_area_id = diesel::insert_into(viti_areas::table)
